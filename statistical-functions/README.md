...
* Correlation Coefficient (r);
	...
	<img src="https://render.githubusercontent.com/render/math?math=r = {n({\sum_{\substack{i=1}} y_{ref_i} y_{pred_i}})} - ({{\sum_{\substack{i=1}} y_{ref_i}}})({{\sum_{\substack{i=1}} y_{pred_i}}})">
